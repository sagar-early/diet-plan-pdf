...
const NutritionistCard: React.FC<NutritionistCardProps> = ({
  ...
  return <div className={`ef-nutrition-summary-compact ${className}`} role="region" aria-label="Daily intake: 1400 kilocalories; Protein 80 grams; Carbohydrates 150 grams; Fats 50 grams">
      <div className="ef-nutrition-layout">
        {/* Calories - Left aligned */}
        <div className="ef-calories-section">
          <span className="ef-nutrition-label font-bold">Calories</span>
          <span className="ef-nutrition-value">1400 Kcal</span>
        </div>
        
        {/* Macros - Right aligned */}
        <div className="ef-macros-section">
          <div className="ef-macro-item-compact mx-[10px]">
          ...
          <div className="ef-macro-item-compact mx-[300px]">
          ...
          <div className="ef-macro-item-compact mx-[50px]">
