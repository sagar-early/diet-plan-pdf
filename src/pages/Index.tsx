    ...
    <>
      ...
      <main className="ef-page">
        <div className="ef-page-content">
          ...
          <div className="ef-meal-card-new">
            <div className="ef-meal-header">
              <h3 className="ef-meal-title-new">Pre-Breakfast</h3>
              <div className="ef-meal-total">77 Kcal</div>
            </div>
            <div className="ef-meal-time-new">06:30 – 07:00</div>
            <div className="ef-meal-separator-new"></div>
            ...
            <div className="ef-meal-sections">
              <div className="ef-meal-section">
                <div className="ef-content-area">
                  ...
                  <div className="ef-dotted-separator"></div>
          ...
          <div className="ef-meal-card-new">
            <div className="ef-meal-header">
              <h3 className="ef-meal-title-new">Breakfast</h3>
              <div className="ef-meal-total">1127 Kcal</div>
            </div>
            <div className="ef-meal-time-new">07:30 – 08:30</div>
            <div className="ef-meal-separator-new"></div>
          ...
          <div className="ef-meal-card-new">
            <div className="ef-meal-header">
              <h3 className="ef-meal-title-new">Lunch</h3>
              <div className="ef-meal-total">1198 Kcal</div>
            </div>
            <div className="ef-meal-time-new">12:30 – 13:30</div>
            <div className="ef-meal-separator-new"></div>
          ...
          <div className="ef-meal-card-new">
            <div className="ef-meal-header">
              <h3 className="ef-meal-title-new">Evening Snack</h3>
              <div className="ef-meal-total">254 Kcal</div>
            </div>
            <div className="ef-meal-time-new">16:30 – 17:30</div>
            <div className="ef-meal-separator-new"></div>
          ...
          <div className="ef-meal-card-new">
            <div className="ef-meal-header">
              <h3 className="ef-meal-title-new">Dinner</h3>
              <div className="ef-meal-total">605 Kcal</div>
            </div>
            <div className="ef-meal-time-new">19:30 – 21:00</div>
            <div className="ef-meal-separator-new"></div>
        ...
        <div className="ef-cheat-meal-new">
          <div className="ef-cheat-content-new">
            ...
            <div className="ef-cheat-text">
              ...
              <p className="ef-cheat-subtitle-refined">— because balance matters. Enjoy your favorite treat in moderation.</p>
            </div>
          </div>
        </div>
      </main>
      ...
      {/* Full-width footer */}
      <footer className="ef-footer-new">
        <div className="ef-footer-content-new">
          ...
          <div className="ef-footer-text">
            <a href="https://www.early.fit" target="_blank" rel="noopener noreferrer" className="ef-footer-link">
